...
/// </summary>
public sealed class WpfSavePositionBehavior : Behavior<Window> {
    /// <summary>
    /// Сервис сериализации.
    /// </summary>
    public static readonly DependencyProperty SerializationServiceProperty = DependencyProperty.Register(
        nameof(SerializationService), typeof(ISerializationService), typeof(WpfSavePositionBehavior),
    ...
    public static readonly DependencyProperty ConfigPathProperty = DependencyProperty.Register(
        nameof(ConfigPath), typeof(string), typeof(WpfSavePositionBehavior), new PropertyMetadata(default(string)));
